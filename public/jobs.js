      ...
      if (data.count === 0) {
        ...
        for (let i = 0; i < data.jobs.length; i++) {
          ...
          let rowHTML = `
            ...
            <td><button type="button" class="editButton" data-id="${data.jobs[i]._id}">edit</button></td>
            <td><button type="button" class="deleteButton" data-id="${data.jobs[i]._id}">delete</button></td>`;
